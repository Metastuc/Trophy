...
export const useAuthenticationDrawerStateStore: UseBoundStore<StoreApi<tAuthenticationDrawerState>> =
...
export const useAuthenticationDrawerNavigationStore: UseBoundStore<StoreApi<tAuthenticationNavigationState>> =
