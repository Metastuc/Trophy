...
//             <footer className="relative flex flex-1 pb-14">
//                 <div className="flex w-full flex-col justify-end overflow-auto">
//                     <div className="border-blue-400 p-4">
//                         {messages.map((message, index) => {
...
//                     </div>
//                 ) : (
//                     <div className="bg-blue100/90 absolute bottom-0 flex h-14 w-full rounded-lg p-2 items-center justify-center">
//                         <p className="absolute bottom-4 left-4 text-sm text-white">Login to chat</p>
//                     </div>
//                 )}
//             </footer>
...
export function Chatroom() {
    ...
    const sendMessage = () => {
        ...
        // Add local message
        // setMessages((prev) => {
        //     const updated = [...prev, { text, sender: peerId, displayName: user }];
        //     return updated.length > MAX_CHATS ? updated.slice(-MAX_CHATS) : updated;
        // });
