...
export function ProfileForm<T extends Array<ProfileFormFields>>({
    fields,
    initialValues,
    onSubmit,
    disabledFields,
    ...
    function handleChange({ field, value }: { field: ProfileFormFields; value: unknown }) {
        setFormValues((state) => ({
            ...state,
            [field]: value,
        }));
    ...
    const renderField: Record<ProfileFormFields, () => JSX.Element> = {
        bio() {
            return (
                <div>
